...
\begin{center}
    ...
    \href{https://linkedin.com/in/james-marsh2111}{\underline{linkedin.com/in/james-marsh2111}}
\end{center}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
         \textbf{Relevant Coursework}{: Data Structures \& Algorithms, Software Engineering, Full Stack Web Development, Discrete Structures, Computer Science Theory, Systems Administration
         }
        }}
     \end{itemize}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Modeled staffing procedures in Grant County PUD to forecast effects of budget changes using Visual Basic}
      \resumeItemListEnd
