  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
         \textbf{Relevant Coursework}{: Data Structures \& Algorithms, Software Engineering, Full Stack Web Development, Programming Languages, Discrete Structures, Programming With C
         }
        }}
     \end{itemize}
...
\section{Technical Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Wrote a new web application to generate custom accounting reports (Javascript, R, and MySQL)}
        \resumeItem{Developed additional functionality for employee benchmarking tools (Javascript, R, and MySQL)}
        \resumeItem{Modeled power line repair procedures to forecast the impact of budget changes on repair time (Excel, VBA)}
      \resumeItemListEnd
